...
#  [35.0, "tavern_stand", 0, 472, arf_cyclic|arf_loop_pos_0_25],
 ...
 #["jump", acf_enforce_all|acf_displace_position, amf_priority_jump|amf_play|amf_client_prediction|amf_continue_to_next|amf_keep,
 ### Restored jumps code from Warband sourcecode
...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 ["stand_crossbow", 0, amf_client_prediction,
   [2.0, "rifle_stand_ani", 0, 29, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],     #native
...
###[0.8, "run_forward_staff", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ...
 ["run_forward_greatsword", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
    [0.8, "run_twohanded_greatsword", 0, 25, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
##   [0.8, "run_greatsword", 0, 22, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
...
# duration and controlled via weapon speed.
 ["ready_bow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_bow,
  #[1.5, "anim_human", combat+500, combat+530, blend_in_ready|arf_make_custom_sound, pack2f(0.14, 0.44)],
   [1.0, "b2_shoot", 0, 47, blend_in_ready|arf_make_custom_sound, pack2f(0.14, 0.44)],  #by Swyter
 ],
 ["release_bow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_bow,
  #[0.3, "anim_human", combat+530, combat+532, arf_blend_in_2],
   [2.0, "droid_ready", 47, 99, arf_blend_in_2],    #by Swyter
 ],
 #not used
 ...
 ["ready_crossbow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_crossbow,
  ...
  #[0.3, "new_rifle", 21300, 21330, blend_in_ready],  #1866 animation
   [0.3, "rifle_aim", 18, 18, blend_in_ready],  #1866 animation old animation (better for SWC)
 ],
 ["release_crossbow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_crossbow,
  ...
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],   #1866 animation
   [3.5, "rifle_fire_160", 18, 26, arf_blend_in_1],    #1866 animation old (better for SWC)
 ],
...
## [0.3, "anim_human", combat+2200, combat+2210, blend_in_ready],
  #[0.7, "throw_stone", 0, 21, blend_in_ready],
   [1.5, "anim_human", 20500, 20530, blend_in_ready, 0, (0, 0, 0), 0.2],  #acm new  #SW - commented out
...
## [1.0, "anim_human", combat+2210, combat+2225, arf_blend_in_0],
   [1.0, "anim_human", 20530, 20532, arf_blend_in_0],
#SW[0.8, "throw_knife", 30, 70, arf_blend_in_0],   #from release_throwing_knife (doesn't work, I was hoping to keep the spinning knife animation but have the item disapear like stones do...)
 ...
 ["ready_pistol", acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_pistol,
  ...
  [0.3, "pistol_shoot", 14, 14, arf_blend_in_8],            #Lucke189 + CMW animations (fixed by Swyter)  - issue where it doesn't look up/down with aiming tho..
 ],
 ["release_pistol", acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_pistol,
  ...
  [0.3, "aim_sky_pistol", 15, 15, arf_blend_in_1],  #Lucke189 + CMW animations (fixed by Swyter)  - issue where it doesn't look up/down with aiming tho.. #0,3 15, 15 changed by me to test if auto fire can work better with it
 ],
 ...
 ["ready_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [0.5, "kneeling_fire_curve", 10, 10, blend_in_ready],
 ],
 ["release_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [0.1, "kneeling_fire_rise", 10, 15, arf_blend_in_1],
 ],
 ...
 ["ready_swingright_fist", acf_rot_vertical_sword, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_swing_right,
   [ready_durn, "right_swing", 0, 15, blend_in_ready],
   [ready_durn, "anim_human", 24000, 24000, blend_in_ready, 0, (0, 0, 0), 0.25],  #acm new
 ],
 ["release_swingright_fist", acf_rot_vertical_sword, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right,
 ...
 ["ready_swingleft_fist", acf_rot_vertical_sword, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_swing_left,
   [ready_durn, "anim_human", combat+4300, combat+4300, blend_in_ready],
 ],
 ["release_swingleft_fist", acf_rot_vertical_sword, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_left,
 ...
 ["ready_direct_fist", acf_rot_vertical_sword, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_thrust,
   [ready_durn, "direct_fist", 0, 16, blend_in_ready],
   [ready_durn, "anim_human", 24600, 24600, blend_in_ready, 0, (0, 0, 0), 0.25],  #acm new
 ],
 ["release_direct_fist", acf_rot_vertical_sword, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_thrust,
 ...
 ["ready_uppercut_fist", acf_rot_vertical_sword, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_thrust,
   [ready_durn, "uppercut", 0, 17, blend_in_ready],
   [ready_durn, "anim_human", 24900, 24900, blend_in_ready, 0, (0, 0, 0), 0.25],  #acm new
 ],
 ["release_uppercut_fist", acf_rot_vertical_sword, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_thrust,
...
##   [ready_durn, "slashright_twohanded", 5, 20, blend_in_ready],
   [ready_durn, "rtl2h1", 0, 0, blend_in_ready],
   [ready_durn, "swing_rtl", 0, 0, blend_in_ready],
 ],
...
##   [0.62, "slashright_twohanded", 16, 40, blend_in_release],
   [0.61, "swing_rtl", 0, 25, blend_in_release],
 ],
...
##   [0.3, "slashright_twohanded", 45, 61, blend_in_continue],
   [0.5, "swing_rtl", 25, 25, blend_in_continue],
 ],
...
####   [ready_durn, "slashleft_twohanded", 7, 26, blend_in_ready],
   [ready_durn, "ltr2h1", 0, 0, blend_in_ready],
   [ready_durn, "swing_ltr", 0, 0, blend_in_ready],
 ],
...
##   [0.62, "slashleft_twohanded", 20, 45, blend_in_release],
 ...
 ["ready_thrust_twohanded", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
   [ready_durn, "anim_human", 26000, 26010, blend_in_ready],
 ],
 ...
 # [ready_durn, "oh2h1", 1, 1, blend_in_ready],   #acm new
   [ready_durn, "swing_oh_2h", 0, 0, blend_in_ready, 0, (0, 0, 0), 0.95],   #acm new #swy-- too long for an attack (issue #179)
 ],
...
##   [0.63, "attacks_twohanded_overswing", 33, 60, blend_in_release],
 ...
 ["ready_thrust_onehanded",   acf_thrust|acf_rot_vertical_sword|acf_anim_length(100)|acf_enforce_rightside, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_thrust,
   [0.61, "swing_1h_underswing", 0, 0, blend_in_release],
...
##   [0.61, "anim_human", combat+8510, combat+8540, blend_in_release],
   [0.62, "swing_1h_underswing", 0, 25, blend_in_release],
 ],
 ["release_thrust_onehanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_thrust|amf_client_owner_prediction,
   [0.3, "swing_1h_underswing", 25, 25, blend_in_continue],
 ],
...
##   [ready_durn, "attacks_single_righttoleft", 5, 10, blend_in_ready],
   [ready_durn, "swing_rtl1h", 0, 0, blend_in_ready],
 ],
...
##   [0.6, "attacks_single_righttoleft", 10, 26, blend_in_release],
   [0.6, "swing_rtl1h", 0, 25, blend_in_release],
 ],
...
##   [0.4, "attacks_single_righttoleft", 26, 43, blend_in_continue],
   [0.4, "swing_rtl1h", 25, 25, blend_in_continue],
 ],
...
##   [ready_durn, "attacks_single_lefttoright", 12, 21, blend_in_ready],
   [ready_durn, "swing_ltr1h", 0, 0, blend_in_ready],
 ],
...
##   [0.61, "attacks_single_lefttoright", 21, 40, blend_in_release],
   [0.61, "swing_ltr1h", 0, 25, blend_in_release],
 ],
...
##   [0.4, "attacks_single_lefttoright", 40, 50, blend_in_continue],
   [0.4, "swing_ltr1h", 25, 25, blend_in_continue],
 ],
...
##   [ready_durn, "anim_human", combat+9300, combat+9305, blend_in_ready],
   [ready_durn, "swing_oh_1h", 0, 0, blend_in_ready],
  #[ready_durn, "ltr1h1", 0, 0, blend_in_ready],
 ],
...
##   [0.6, "attacks_single_overswing", 16, 35, blend_in_release],
   [0.6, "swing_oh_1h", 0, 25, blend_in_release],
 ],
 ["release_overswing_onehanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_overswing|amf_client_owner_prediction,
   [0.02, "swing_oh_1h", 25, 25, blend_in_continue],
 ],
...
##   [ready_durn, "attacks_staff_uptodown", 9, 34, blend_in_ready],
   [ready_durn, "swing_oh_pole", 0, 0, blend_in_ready],
 ],
...
##   [ready_durn, "attacks_staff_lefttoright", 6, 20, blend_in_ready],
   [ready_durn, "swing_ltr_pole", 0, 0, blend_in_ready],
 ],
...
##   [ready_durn, "attacks_staff_righttoleft", 3, 18, blend_in_ready],
   [ready_durn, "swing_rtl_pole", 0, 0, blend_in_ready],
 ],
...
#   [0.3, "anim_human", defend+320, defend+330, arf_blend_in_1],
 ...
 ["defend_forward_onehanded", acf_rot_vertical_sword, amf_play|amf_restart|amf_priority_defend|amf_use_defend_speed|amf_use_inertia|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
...
#   [defend_duration, "parry_attack_thrust_onehanded", 20, 32, arf_blend_in_1],
 ...
 ["defend_forward_onehanded_keep", acf_rot_vertical_sword, amf_priority_defend|amf_use_defend_speed|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
...
##   [defend_parry_duration_3, "defend_forward_onehanded_parry", 91, 110, arf_blend_in_1],
 ...
 ["defend_up_onehanded", acf_rot_vertical_sword, amf_play|amf_restart|amf_priority_defend|amf_use_defend_speed|amf_use_inertia|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
...
#   [defend_duration, "parry_attack_overswing_onehanded", 7, 19, blend_in_release],
 ...
 ["defend_up_onehanded_keep", acf_rot_vertical_sword, amf_priority_defend|amf_use_defend_speed|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
...
##   [defend_parry_duration_3, "defend_up_onehanded_parry", 86, 109, arf_blend_in_1],
 ...
 ["defend_right_onehanded", acf_rot_vertical_sword, amf_play|amf_restart|amf_priority_defend|amf_use_defend_speed|amf_use_inertia|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
...
#   [defend_duration, "parry_attack_slashright_onehanded", 9, 22, arf_blend_in_1],
 ...
 ["defend_right_onehanded_keep", acf_rot_vertical_sword, amf_priority_defend|amf_use_defend_speed|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
...
##   [defend_parry_duration_3, "defend_right_onehanded_parry", 80, 96, arf_blend_in_1],
 ...
 ["defend_left_onehanded", acf_rot_vertical_sword, amf_play|amf_restart|amf_priority_defend|amf_use_defend_speed|amf_use_inertia|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
##   [defend_duration, "anim_human", defend+1310, defend+1320, blend_in_defense],
 ...
 ["defend_left_onehanded_keep", acf_rot_vertical_sword, amf_priority_defend|amf_use_defend_speed|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
...
#   [0.6,  "anim_human", blow+5200, blow+5220, arf_blend_in_3],
 ...
 ["fall_face_hold", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [1.2, "kicked_down", 5, 38, arf_blend_in_16|arf_make_custom_sound, pack2f(0.5, 0.0), (0,0,0), 0.6],
 ],
...
## Crouch Anims - Kham
 ...
 ["crouch_pike_recover",  0, amf_client_prediction,
   [11.0, "crouch_stand_man", 0, 315, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], #1h Crouch Ready
 ],
...
["deflect_forward_onehanded_keep", 0, amf_priority_parried+1|amf_play, 
 ...
 ## End Anims for Crouch

 ### Unused human animations start from here.
#["unused_human_anim_01", 0, 0, [1.0, "anim_human", 0, 1, 0]],
#["unused_human_anim_02", 0, 0, [1.0, "anim_human", 0, 1, 0]], #Replaced with Alt Sword Anim

## Replaced 17 anims for Crouch
...
# Deflect End
 ...
 #["unused_human_anim_22", 0, 0, [1.0, "anim_human", 0, 1, 0]], # Commented for Dodge R
...
#test flag animations begin

 ["ft_amf_priority_attack", 0, amf_priority_attack|amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_amf_priority_equip", 0, amf_priority_equip|amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_blend_in_1", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_blend_in_1]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_blend_in_3", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_blend_in_3]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_blend_in_5", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_blend_in_5]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_blend_in_6", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_blend_in_6]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_blend_in_10", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_blend_in_10]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_blend_in_32", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_blend_in_32]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_blend_in_48", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_blend_in_48]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_blend_in_64", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_blend_in_64]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_blend_in_128", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_blend_in_128]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_blend_in_254", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_blend_in_254]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_make_custom_sound", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_make_custom_sound]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_two_handed_blade", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_two_handed_blade]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_stick_item_to_left_hand", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_stick_item_to_left_hand]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_cyclic", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_cyclic]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_arf_use_stand_progress", 0, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, arf_use_stand_progress]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_amf_start_instantly", 0, amf_start_instantly|amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_amf_use_cycle_period", 0, amf_use_cycle_period|amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_amf_accurate_body", 0, amf_accurate_body|amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_amf_play", 0, amf_play|amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_amf_restart", 0, amf_restart|amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_amf_hide_weapon", 0, amf_hide_weapon|amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_amf_use_inertia", 0, amf_use_inertia|amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_acf_enforce_rightside", acf_enforce_rightside, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_acf_enforce_all", acf_enforce_all, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_acf_parallels_for_look_slope", acf_parallels_for_look_slope, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_acf_lock_camera", acf_lock_camera, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_acf_rotate_body", acf_rotate_body, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_acf_ignore_slope", acf_ignore_slope, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_acf_right_cut", acf_right_cut, amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_acf_anim_length500", acf_anim_length(500), amf_client_prediction,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [6.0, "man_cheer", 0, 185, 0]],#   [6.0, "man_cheer", 0, 185, arf_blend_in_1],

 ["ft_no_flag", 0, 0,
   [6.0, "man_cheer", 0, 185, 0]],

###flag test animations end

 ["ready_musket1", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_prediction|amf_rider_rot_crossbow,
   [0.5, "new_rifle_crouch", combat+1300, combat+1330, blend_in_ready],
 ],
 
 ["chaingun_rotate_test", acf_rot_vertical_bow|acf_anim_length(30), amf_priority_throw|amf_play|amf_client_owner_prediction|amf_rider_rot_throw,#human anim73
  #[0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],
   [0.1, "rifle_aim_hip", 19, 24, arf_blend_in_1]],#   [0.1, "rifle_aim_hip", 19, 24, arf_blend_in_1],
...
# ["unused_human_anim_89", 0, [1.0, "anim_human", 0, 1, 0]],
 ...
 ["jetpack", acf_displace_position|acf_enforce_lowerbody|acf_rotate_body, amf_client_prediction|amf_priority_die|amf_play,    #working
 #["jetpack", acf_displace_position,    #testing
 #["jetpack", acf_enforce_lowerbody|acf_displace_position,
  [0.8, "roll", 3, 65, arf_blend_in_1, 0, (0, 5.5, 0), 0],  #(right,  forward,  down), delay
...
# ["unused_human_anim_100", 0, [1.0, "anim_human", 0, 1, 0]],
 ...
 ["bash_knocked", acf_enforce_all|acf_align_with_ground, amf_client_prediction|amf_priority_die|amf_play,
   [6.0, "kicked_down", 1, 112, arf_blend_in_2],
 ],
# strike_chest_front_stop
...
# strike_head_front_left
 ...
 ["release_bash", acf_enforce_all|acf_right_cut, amf_client_prediction|amf_priority_die|amf_play,
  ...
  #[0.8, "wb_defend_shield_right", 11, 36, blend_in_release],   #shield bash from warband
   [1.8, "karate_kick", 1, 60, arf_blend_in_3],   #karate_kick_by_mongol
 ],
...
["crouch", acf_displace_position|acf_enforce_all|acf_rotate_body, amf_client_prediction|amf_priority_die|amf_play, 
    [0.8, "roll", 0, 70, arf_use_walk_progress|arf_blend_in_1, 0, (0, 5.5, 0), 0],
 ],


["dodge_left", acf_displace_position|acf_align_with_ground|acf_enforce_all|acf_rotate_body, amf_client_prediction|amf_priority_die|amf_play, 
    [0.8, "dodgeL", 0, 67, arf_use_walk_progress|arf_blend_in_1, 0, (-5.5, 3.0, 0), 0],
 ],

["dodge_right", acf_displace_position|acf_align_with_ground|acf_enforce_all|acf_rotate_body, amf_client_prediction|amf_priority_die|amf_play, 
    [0.8, "dodgeR", 0, 67, arf_use_walk_progress|arf_blend_in_1, 0, (5.5, 3.0, 0) , 0],
 ],
