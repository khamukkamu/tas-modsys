     ...
     #SW - new races     
      ...
      ("race_tusken",[],"Tusken",
       [
           ...
           (assign,"$character_gender",tf_male),#male
           (jump_to_menu,"mnu_start_character_0"),
        ]
       ),    
     #------------------------------------------------------         
...
##        ]),
      ("begin_adventuring",[],"Start to navigate the Galaxy.",[
       ...
       (troop_raise_skill, "trp_player","skl_weapon_master",2),#was 5, now 0, ranged weapon prof would raise too quickly with wm lvl 5,
...
#SW - new classes (commented out old ones below)
      (try_begin),
        ...
        (eq,"$character_gender",tf_male),
        (troop_raise_attribute, "trp_player",ca_intelligence,4),#2
        (troop_raise_attribute, "trp_player",ca_charisma,4),#2
        (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,30),#20
        (troop_raise_proficiency, "trp_player",wpt_two_handed_weapon,10),#20

        (troop_add_item, "trp_player","itm_energy_shield_yellow_small",imod_battered),
    #(troop_add_item, "trp_player","itm_leather_boots",0),
    (troop_add_item, "trp_player","itm_ind_clothes_noble_purple",0),
    ...
    (troop_add_item, "trp_player","itm_baton2",0),
    (troop_add_item, "trp_player","itm_speeder",0),
    #(troop_add_item, "trp_player","itm_dried_meat",0),
    (troop_add_items, "trp_player","itm_vagnerian_canape",2),
    #(troop_add_item, "trp_player","itm_mujo_fruit",0),
    
        (troop_set_slot, "trp_player", slot_troop_renown, 300),#200
        (call_script, "script_change_player_honor", 5),#3
        (troop_add_gold, "trp_player", 370),#200
      (else_try),
        (eq,"$background_type",cb0_ambassador),
    ...
    #(troop_add_item, "trp_player","itm_mujo_fruit",0),
      ...
      (else_try),
        ...
        (eq,"$character_gender",tf_male),
        (troop_raise_attribute, "trp_player",ca_intelligence,2),#1
        (troop_raise_attribute, "trp_player",ca_charisma,2),#2
    (troop_raise_attribute, "trp_player",ca_strength,1),
    ...
    (troop_add_item, "trp_player","itm_ind_clothes_outfsmuggler_green",0),
    ...
    (troop_add_item, "trp_player","itm_tools",0),
      ...
      (else_try),
       ...
       (try_begin),# normal human soldiers' equipment attributes differ from that of clones
    ...
    (troop_raise_attribute, "trp_player",ca_strength,2),
        (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,50),#10
        (troop_raise_proficiency, "trp_player",wpt_firearm,25),#30
       ...
       (else_try),# Clones get Clone Trooper Equipment
        #(eq,"$character_gender",tf_tusken),
        (troop_get_type, ":type", "trp_player"),##
        (eq, ":type", tf_tusken),##
        (troop_raise_attribute, "trp_player",ca_agility,4),
        (troop_raise_attribute, "trp_player",ca_strength,4),
        (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,30),#10
        (troop_raise_proficiency, "trp_player",wpt_firearm,40),#30
        (troop_raise_proficiency, "trp_player",wpt_crossbow,75),##

        (troop_add_item, "trp_player","itm_phase_ii_clonepack",0),
        (troop_add_item, "trp_player","itm_phase_ii_armor_clean",0),
        (troop_add_item, "trp_player","itm_dc15s",0),
        (troop_add_item, "trp_player","itm_laser_bolts_blue_rifle",0),
        (troop_add_item, "trp_player","itm_vibro_blade1",0),
        (troop_add_item, "trp_player","itm_phase_ii_helmet_clean",0),
        #(troop_add_item, "trp_player","itm_speeder",0),
        #(troop_add_item, "trp_player","itm_dried_meat",0),
    
        (troop_set_slot, "trp_player", slot_troop_renown, 30),#50
        (call_script, "script_change_player_honor", 6),#3
      ...
      (else_try),
        ...
        (troop_raise_attribute, "trp_player",ca_agility,1),
        (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,20),
        (troop_raise_proficiency, "trp_player",wpt_firearm,60),#20
        ...
        (troop_add_item, "trp_player","itm_speeder",0),
        #(troop_add_item, "trp_player","itm_dried_meat",0),
        (troop_add_item, "trp_player","itm_Container_spice_1",0),
        (troop_add_item, "trp_player","itm_ale",0),
        (troop_add_item, "trp_player","itm_droid_parts",0),
        (troop_add_item, "trp_player","itm_tools",0),
    
        (troop_set_slot, "trp_player", slot_troop_renown, 25),
        (call_script, "script_change_player_honor", 2),#3
        (troop_add_gold, "trp_player", 50),#100
      (else_try),
        (eq,"$background_type",cb0_smuggler),
        (eq,"$character_gender",tf_female),
        (troop_raise_attribute, "trp_player",ca_intelligence,1),
    ...
    (troop_raise_attribute, "trp_player",ca_strength,3),
        (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,45),#10
        (troop_raise_proficiency, "trp_player",wpt_firearm,50),#30
        (troop_raise_proficiency, "trp_player",wpt_crossbow,50),#30

        (troop_add_item, "trp_player","itm_mand_arm_dummy",imod_thick),
        (troop_add_item, "trp_player","itm_mand_helm_dummy",imod_thick),
        (troop_add_item, "trp_player","itm_dc17sa",imod_strong),
        (troop_add_item, "trp_player","itm_laser_bolts_blue_rifle",0),
        (troop_add_item, "trp_player","itm_vibro_blade1",0),
        #(troop_add_item, "trp_player","itm_imperial_stormtrooper_boots_incinerator",0),
        (troop_add_item, "trp_player","itm_black_gloves",0),
        #(troop_add_item, "trp_player","itm_dried_meat",0),
    
        (troop_set_slot, "trp_player", slot_troop_renown, 25),#50
        (call_script, "script_change_player_honor", 3),#3
    ...
    (troop_raise_attribute, "trp_player",ca_strength,2),
      ...
      (else_try),
        ...
        (eq,"$character_gender",tf_male),
        (troop_raise_attribute, "trp_player",ca_agility,3),
    (troop_raise_attribute, "trp_player",ca_strength,1),  # had to give 12 strength to guarantee they could use the 1h lightsaber ;mando - lowered, light saber item replaced by vibro sword
        (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,20),
    ...
    (troop_raise_skill, "trp_player","skl_power_draw",1),
        ...
        (troop_add_item, "trp_player","itm_vibro_sword3_gold",imod_battered),
        (troop_add_item, "trp_player","itm_force_block",0),
        ...
        (troop_set_slot, "trp_player", slot_troop_renown, 50),
        (call_script, "script_change_player_honor", 3),
        (troop_add_gold, "trp_player", 20),#50
      (try_end),    
#------------------------------------------------------
...
# ##        (troop_raise_proficiency, "trp_player",5,10),
    ...
    (try_begin),
      ...
      (call_script, "script_troop_add_gold","trp_player", 250),#500 
      ...
      (troop_add_item, "trp_player","itm_laser_bolts_blue_rifle",0),#
      #(troop_add_item, "trp_player","itm_dc17sa",0),
      (troop_add_item, "trp_player","itm_wpn_blaster_dc17m_auto", 0),
    ...
    (else_try),
      ...
      (party_add_members, "p_main_party", "trp_rebel_recruit", 20),#5
      (call_script, "script_troop_add_gold","trp_player", 500),#250
      ...
      #add items
      (troop_add_item, "trp_player","itm_ind_clothes_outfsmuggler_green",0),
      (troop_add_item, "trp_player","itm_eyepiece_leadership",0),
      ...
      (troop_add_item, "trp_player","itm_e5",0),
      (troop_add_item, "trp_player","itm_protein_pack",0),
      (troop_add_item, "trp_player","itm_carbohydrate_pack",0),
      #equip the items
      (troop_equip_items, "trp_player"),
    ...
    (else_try),
      ...
      (troop_set_slot, "trp_player", slot_troop_renown, 150),   # may be necessary so you aren't hired as a merc when you join the faction      
    ...
    (else_try),
      (troop_set_slot, "trp_player", slot_troop_renown, 50),
      (call_script, "script_troop_add_gold","trp_player", 180),#100
...
game_menus += [
  ...
  ("mandalorian", [], "Mandalorian culture",
    ...
    #   (troop_add_item, ":knight", "itm_speeder",                          0),
        ...
        (try_begin),
          (eq, ":rand", 0),
          (troop_add_item, ":knight", "itm_mand_arm_dummy",    0),
          (troop_add_item, ":knight", "itm_mand_helm_dummy",     0),
...
### MF - Add any units you want to test with below, look in troop.py for the troop_id      
    ...
    (party_add_members, "p_main_party", "trp_imperial_army_trooper", 5),
...
#   Set player skills and equipment based on class
  ...
  # Subclass 1:  Knight
     ...
     (troop_raise_skill, "trp_player", skl_riding, 6),
       ...
       (troop_raise_proficiency_linear, "trp_player", wpt_one_handed_weapon, 300),
       (troop_raise_proficiency_linear, "trp_player", wpt_two_handed_weapon, 300),
       (troop_raise_proficiency_linear, "trp_player", wpt_polearm, 300),
       (troop_raise_proficiency_linear, "trp_player", wpt_archery, 300),
       (troop_raise_proficiency_linear, "trp_player", wpt_crossbow, 300),
       (troop_raise_proficiency_linear, "trp_player", wpt_throwing, 300),
     (troop_raise_proficiency_linear, "trp_player", wpt_firearm, 300),
       (troop_set_type, "trp_player",tf_tusken),
      (troop_add_item, "trp_player","itm_phase_ii_helmet_501",0),
       (troop_add_item, "trp_player","itm_phase_ii_armor_fives",0),
       (troop_add_item, "trp_player","itm_phase_ii_arc_kama",0),
       (troop_add_item, "trp_player","itm_baton2",0),
       #(troop_add_item, "trp_player","itm_energy_shield_yellow_small",0),
       (troop_add_item, "trp_player","itm_dc15a",0),
       (troop_add_item, "trp_player","itm_laser_bolts_blue_rifle",0),
       (troop_equip_items, "trp_player"),
  # Subclass 2: Lancer
  (else_try),
     ...
     (troop_raise_skill, "trp_player", skl_riding, 4),
       ...
       (troop_raise_proficiency_linear, "trp_player", wpt_one_handed_weapon, 250),
       (troop_raise_proficiency_linear, "trp_player", wpt_two_handed_weapon, 250),
       (troop_raise_proficiency_linear, "trp_player", wpt_polearm, 250),
       (troop_raise_proficiency_linear, "trp_player", wpt_archery, 250),
       (troop_raise_proficiency_linear, "trp_player", wpt_crossbow, 250),
       (troop_raise_proficiency_linear, "trp_player", wpt_throwing, 250),
     (troop_raise_proficiency_linear, "trp_player", wpt_firearm, 250),
       (troop_set_type, "trp_player",tf_tusken),
      (troop_add_item, "trp_player","itm_phase_ii_helmet_501",0),
       (troop_add_item, "trp_player","itm_phase_ii_armor_501",0),
       (troop_add_item, "trp_player","itm_phase_ii_clonepack",0),
       (troop_add_item, "trp_player","itm_vibro_blade1",0),
       #(troop_add_item, "trp_player","itm_energy_shield_yellow_small",0),
       (troop_add_item, "trp_player","itm_dc15a_hip",0),
       (troop_add_item, "trp_player","itm_laser_bolts_blue_rifle",0),
       (troop_equip_items, "trp_player"),
  ...
  (else_try),
     ...
     #(troop_add_item, "trp_player","itm_transparent_helmet",0),
       (troop_add_item, "trp_player","itm_phase_ii_armor_worn",0),
       (troop_add_item, "trp_player","itm_transparent_feet",0),
       (troop_add_item, "trp_player","itm_vibro_blade1",0),
       #(troop_add_item, "trp_player","itm_energy_shield_yellow_small",0),
       (troop_add_item, "trp_player","itm_dc15s",0),
...
# Main  Class 2: Infantry
  ...
  (else_try),
     ...
     (troop_raise_proficiency_linear, "trp_player", wpt_firearm, 200),
     (troop_add_item, "trp_player","itm_transparent_helmet",0),
       (troop_add_item, "trp_player","itm_Jedi_clothes_robes_tan",0),
       #(troop_add_item, "trp_player","itm_leather_boots",0),
...
#    (troop_add_item, "trp_player","itm_force_push",0),
  ...
  (else_try),
     ...
     (troop_add_item, "trp_player","itm_transparent_helmet",0),
       (troop_add_item, "trp_player","itm_jedi_robe_f",0),
       #(troop_add_item, "trp_player","itm_leather_boots",0),
     (troop_add_item, "trp_player","itm_force_lightning_ammo",0),
  ...
  (else_try),
     ...
     #(troop_add_item, "trp_player","itm_transparent_helmet",0),
       (troop_add_item, "trp_player","itm_jedi_robe_d",0),
       #(troop_add_item, "trp_player","itm_leather_boots",0),
  ...
  # (else_try),
       ...
       # (troop_raise_proficiency_linear, "trp_player", wpt_crossbow, 20),
       # (troop_raise_proficiency_linear, "trp_player", wpt_throwing, 20),
       # (troop_add_item, "trp_player","itm_place_some_legit_item_when_using_this",0),
       # (troop_equip_items, "trp_player"),
  # # Subclass 13: Farmer
  # (else_try),
...
# # Main Class 3: Ranged Infantry
  ...
  # (else_try),
       ...
       # (troop_raise_proficiency_linear, "trp_player", wpt_crossbow, 20),
       # (troop_raise_proficiency_linear, "trp_player", wpt_throwing, 20),
       # (troop_add_item, "trp_player","itm_add_something",0),
       # (troop_equip_items, "trp_player"),
