...
if (not wb_compile_switch and not "BUILD_TLD_WB" in environ):
  ...
  export_dir = "C:/Program Files (x86)/Steam/SteamApps/common/MountBlade Warband/Modules/Turmoil Across the Stars - 0.42 - Release candidate 01/"; wb_compile_switch = 1
