...
#### Freelancer - Kham Implementation ####
  ...
  [anyone,"lord_request_enlistment",
    [
      ...
      (try_end),
      (try_begin),
        (eq, "$g_talk_troop_faction", "fac_rebelalliance"),
        (str_store_string, s5, "@{s3}I can allow you to control one of our {s1}, with a weekly pay of {s2}."),
      (else_try),
        (str_store_string, s5, "@{s3}I can take you on as a {s1}, with a weekly pay of {s2}."),
      (try_end),
      ], "I've got room in my ranks for someone of your disposition, {playername}.{s5} And food, of course.  Plenty of room for promotion and you'll be equipped as befits your rank. You'll have your take of what you can scavange in battle, too.  What do you say?", "lord_request_enlistment_confirm", []],
  
  [anyone|plyr,"lord_request_enlistment_confirm", [],
    "That seems fair and better than working for the Jawas. I'm with you, Commander.", "close_window",
    [
