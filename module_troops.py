...
["spacestation_1_seneschal", "Spacestation Commander", "Castle 1 Administrator", tf_hero|tf_randomize_face|tf_is_merchant, 0,reserved,  fac_neutral,[itm_lobot_headgear,itm_ind_clothes_outfsmuggler_red],   def_attrib|level(2),wp(20),knows_common, sw_man_face_1, sw_man_face_2],
...
["spacestation_3_seneschal", "Spacestation Commander", "Castle 3 Administrator", tf_hero|tf_randomize_face|tf_is_merchant, 0,reserved,  fac_neutral,[itm_lobot_headgear,itm_ind_clothes_outfsmuggler_black],   def_attrib|level(2),wp(20),knows_common, sw_man_face_1, sw_man_face_2],
["spacestation_4_seneschal", "Spacestation Commander", "Castle 4 Administrator", tf_hero|tf_randomize_face|tf_is_merchant, 0,reserved,  fac_neutral,[itm_lobot_headgear,itm_ind_clothes_outfsmuggler_red],   def_attrib|level(2),wp(20),knows_common, sw_man_face_1, sw_man_face_2],
...
["spacestation_6_seneschal", "Spacestation Commander", "Castle 6 Administrator", tf_hero|tf_randomize_face|tf_is_merchant, 0,reserved,  fac_neutral,[itm_lobot_headgear,itm_ind_clothes_outfsmuggler_black],   def_attrib|level(2),wp(20),knows_common, sw_man_face_1, sw_man_face_2],
["spacestation_7_seneschal", "Spacestation Commander", "Castle 7 Administrator", tf_hero|tf_randomize_face|tf_is_merchant, 0,reserved,  fac_neutral,[itm_lobot_headgear,itm_ind_clothes_outfsmuggler_red],   def_attrib|level(2),wp(20),knows_common, sw_man_face_1, sw_man_face_2],
...
["spacestation_9_seneschal", "Spacestation Commander", "Castle 9 Administrator", tf_hero|tf_randomize_face|tf_is_merchant, 0,reserved,  fac_neutral,[itm_lobot_headgear,itm_ind_clothes_outfsmuggler_black],   def_attrib|level(2),wp(20),knows_common, sw_man_face_1, sw_man_face_2],
["spacestation_10_seneschal", "Spacestation Commander", "Castle 10 Administrator", tf_hero|tf_randomize_face|tf_is_merchant, 0,reserved,  fac_neutral,[itm_lobot_headgear,itm_ind_clothes_outfsmuggler_red],   def_attrib|level(2),wp(20),knows_common, sw_man_face_1, sw_man_face_2],
...
#SW - town_10 = Kashyyyk, give wookiee armor
["mainplanet_kashyyyk_arena_master","Arena Master","Tournament Master",tf_hero|tf_wookiee|tf_randomize_face, scn_mainplanet_kashyyyk_arena|entry(52),reserved,  fac_commoners,[],   def_attrib|level(2),wp(20),knows_common,wookiee_face1, wookiee_face2],
...
#SW- town_8 = geonosian
["mainplanet_geonosis_weaponsmith", "Weaponsmith","Weaponsmith",tf_hero|tf_geonosian|tf_randomize_face|tf_is_merchant, 0, 0, fac_commoners,[itm_geonosian_sonic_rifle,itm_sonic_beam_rifle],def_attrib|level(12),wp(80),knows_inventory_management_10, geonosian_face1, geonosian_face2],
#SW - town_9 = Mon Cal, give mon calamari armor
...
#SW- town_8 = geonosian
["mainplanet_geonosis_mayor", "Planet_Administrator", "Planet_Administrator", tf_hero|tf_geonosian|tf_randomize_face, 0,reserved,  fac_neutral,[itm_geonosian_sonic_pistol,itm_sonic_beam_pistol],   def_attrib|level(2),wp(20),knows_common,  geonosian_face1, geonosian_face2],
#SW - town_9 = Mon Cal, give mon calamari armor
...
#SW - town_10 = Kashyyyk, give wookiee armor
["mainplanet_kashyyyk_mayor", "Planet_Administrator", "Planet_Administrator", tf_hero|tf_wookiee|tf_randomize_face, 0,reserved,  fac_neutral,[],     def_attrib|level(2),wp(20),knows_common,  wookiee_face1, wookiee_face2],
