...
kham_lightsaber_deflection_ai,
      ...
      #SWY - trigger to make unique agents behavior - custom scripting
      (0.352, 0, ti_once, [], [(call_script,"script_swy_unique_units_stuff",-1)]),
    ]+common_helmet_view+ utility_triggers + extended_battle_menu + common_division_data + division_order_processing + real_deployment + formations_triggers + AI_triggers + kham_iron_sights_triggers,
  ),
  ...
  (
   ...
   #SW - modified so you do not remove your helmet (removed af_override_head flag) also switched weapon to a durasteel staff
    ...
    ]+common_helmet_view+ utility_triggers + extended_battle_menu + common_division_data + division_order_processing + real_deployment + formations_triggers + AI_triggers,
  ),
