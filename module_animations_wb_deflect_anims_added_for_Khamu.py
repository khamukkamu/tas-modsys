...
#  [35.0, "tavern_stand", 0, 472, arf_cyclic|arf_loop_pos_0_25],
 ...
 ["jump", acf_displace_position|acf_rot_vertical_bow|acf_rotate_body|acf_rotate_body, amf_priority_jump|amf_client_prediction|amf_restart|amf_keep,

 [0.5, "jump3", 1, 1, arf_blend_in_1, 0, (0, 5, 3), 0.4], #new jump by swyter
...
##   [0.8, "jump_loop", 0, 30, arf_blend_in_2|arf_cyclic],
 ...
 [0.3, "sw_jump1", 30, 1, arf_blend_in_1, 0, (0, 0, 0), 0.3], #new jump by swyter
...
# duration and controlled via weapon speed.
 ...
 ["ready_crossbow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_crossbow,
  ...
  #[0.3, "new_rifle", 21300, 21330, blend_in_ready],	#1866 animation
   [0.3, "rifle_aim", 19, 19, blend_in_ready],	#1866 animation old animation (better for SWC)
 ],
 ["release_crossbow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_crossbow,
  ...
  #[0.1, "anim_human", 21330, 21331, arf_blend_in_1],		#1866 animation
   [0.1, "rifle_aim", 19, 24, arf_blend_in_1],		#1866 animation old (better for SWC)
 ],
 ...
 ["ready_javelin", acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_throw,
   [0.3, "rifle_aim_hip", 19, 19,  blend_in_ready],	#animation from WWII China Battlefield
 ],
 ["release_javelin", acf_rot_vertical_bow, amf_priority_throw|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_throw,
   [0.1, "rifle_aim_hip", 19, 24, arf_blend_in_1],		#animation from WWII China Battlefield
 ],
...
##   [0.62, "slashleft_twohanded", 20, 45, blend_in_release],
 ...
 ["ready_thrust_twohanded", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
   [ready_durn, "swing_1h_underswingo", 0, 0, blend_in_ready],
   [0.63, "rtl1h1", 0, 0, blend_in_release],
...
#["unused_human_anim_02", 0, 0, [1.0, "anim_human", 0, 1, 0]], #Replaced with Alt Sword Anim
 ...
 ["saber_deflect_poses_1", 0, 0, [1.0, "saber_deflect_poses", 10, 10, arf_blend_in_0]],
 ["saber_deflect_poses_2", 0, 0, [1.0, "saber_deflect_poses", 20, 20, arf_blend_in_0]],
 ["saber_deflect_poses_3", 0, 0, [1.0, "saber_deflect_poses", 30, 30, arf_blend_in_0]],
 ["saber_deflect_poses_4", 0, 0, [1.0, "saber_deflect_poses", 40, 40, arf_blend_in_0]],
...
# ["unused_human_anim_89", 0, [1.0, "anim_human", 0, 1, 0]],
 ...
 ["jetpack", acf_parallels_for_look_slope|acf_displace_position|acf_enforce_lowerbody|acf_rotate_body, amf_client_prediction|amf_priority_die|amf_play,    #working
...
# strike_head_front_left
 ...
 ["crouch", acf_enforce_all|acf_displace_position, amf_client_prediction|amf_priority_die|amf_play|amf_keep,
   [0.8, "sprint", 0, 24, arf_use_walk_progress|arf_cyclic|arf_cyclic|blend_in_walk, 0, (0, 5, 0), 0.0],
 ],
