...
# enjoy it :P
  ("faction_selection",0,mesh_load_window,[
    ...
    #GALACTIC EMPIRE
    #text
     (create_text_overlay, "$g_option_empire_text", "@Galactic Republic", tf_center_justify),
    #(create_button_overlay, "$g_presentation_obj_1", 0, tf_center_justify),
        (position_set_x, pos1, 480),
    ...
    #REBEL ALLIANCE
    #text
     (create_text_overlay, "$g_option_rebel_text", "@Confederacy of Independent Systems", tf_center_justify),
    #(create_button_overlay, "$g_presentation_obj_1", 0, tf_center_justify),
...
(ti_on_presentation_load, [
  ...
  (try_for_range, ":culture", "fac_culture_1", ":last_culture"),
    (try_begin),
      ...
      (str_store_string, s1, "@Galactic Republic"),
    (else_try),
      (eq, ":culture", "fac_culture_2"),
      (str_store_string, s1, "@Con. of Independent Systems"),
    (else_try),
...
## FormV5 Presentations by motomataru - implemented by Kham
