...
# T U R M O I L   A C C R O S S   T H E   S T A R S   M O D U L E   S Y S T E M
...
skins = [
  (
    ...
    [
		...
		("dsf_male1",0xffdfefe1,["hair_black"],[0xffffffff, 0xffb04717, 0xff632e18, 0xff502a19, 0xff19100c]),
		("dsf_male2",0xffdfefe1,["hair_black"],[0xffffffff, 0xffb04717, 0xff632e18, 0xff502a19, 0xff19100c]),
		("dsf_male3",0xffdfefe1,["hair_black"],[0xffffffff, 0xffb04717, 0xff632e18, 0xff502a19, 0xff19100c]),
		("dsf_male4",0xffdfefe1,["hair_black"],[0xffffffff, 0xffb04717, 0xff632e18, 0xff502a19, 0xff19100c]),
		("dsf_male5",0xffdfefe1,["hair_black"],[0xffffffff, 0xffb04717, 0xff632e18, 0xff502a19, 0xff19100c]),
  ...
  (
    ...
    [
      ...
      ### Test texture for Sernis's female head mesh
      #("test_text",0xffe8dfe5,["hair_blonde"],[0xff502a19, 0xff19100c, 0xff0c0d19]), #Sernis's head mesh test texture
      ...
      ("dsf_fmale1",0xffe3e8ef,["hair_black"],[0xffffffff, 0xffb04717, 0xff502a19, 0xff19100c]),
      ("dsf_fmale2",0xffe3e8ef,["hair_black"],[0xffffffff, 0xffb04717, 0xff502a19, 0xff19100c]),
      ("dsf_fmale3",0xffe3e8ef,["hair_black"],[0xffffffff, 0xffb04717, 0xff502a19, 0xff19100c]),
      ("dsf_fmale4",0xffe3e8ef,["hair_black"],[0xffffffff, 0xffb04717, 0xff502a19, 0xff19100c]),
      ("dsf_fmale5",0xffe3e8ef,["hair_black"],[0xffffffff, 0xffb04717, 0xff502a19, 0xff19100c]),
...
#SW - had to un-comment undead in order to get next skins to work, nevermind, I just modified my skin id's in head_troops.py
 ...
 #SW - new tusken skin
   (
     ...
     [],
     [
		("clone_face_a",0xffffffff,[])
	], #face_textures
     [(voice_die,"snd_clone_die"),(voice_hit,"snd_clone_hit"),(voice_grunt,"snd_clone_grunt"),(voice_grunt_long,"snd_clone_grunt_long"),(voice_yell,"snd_clone_yell"),(voice_warcry,"snd_clone_victory"),(voice_victory,"snd_clone_victory")], #man voice sounds
     "skel_human", 1.0,
    0,0, #psys_swy_damage_sparks,psys_swy_damage_smoke,
    #psys_game_blood,psys_game_blood_2,
   ),
 ...
 #SW - new rodian skin
   (
     ...
     "new_rodian_body", "_", "rodian_handL",
...
#SW - new sullustan skin
 ...
 #SW - new twilek female skin
  (
    ...
    #"twilek_femhead_mesh", twilek_female_face_keys,
    #"twilek_femhead_mesh_test", twilek_female_face_keys,
	...
	[
		...
		#("twilek_fem_head1",0x00ff5757,[]),
		#("twilek_fem_head2",0x00ff5757,[]),
		#("twilek_fem_head3",0x00ff5757,[]),
		#("twilek_fem_head4",0x00ff5757,[]),
		#("twilek_fem_head5",0x00ff5757,[]),
...
#     [(voice_die,"snd_droid_die"),(voice_hit,"snd_droid_hit"),(voice_grunt,"snd_droid_grunt"),(voice_grunt_long,"snd_droid_grunt_long"),(voice_yell,"snd_droid_yell"),(voice_warcry,"snd_droid_victory"),(voice_victory,"snd_droid_victory")], #r2series voice sounds
     ...
     #"skel_human", 1.0,
	 "skel_human", 1.3,		#attempting to make the hitbox a little smaller
	 #"skel_horse", 1.0,	# does doing this seem to cause the game to randomly crash?  seemed to happen a few times after I made this change, so not sure if its related.  AncientWanker confirmed this was an issue
    0,0, #psys_swy_damage_sparks,psys_swy_damage_smoke,
	 #psys_droid_blood,psys_droid_blood_2,
   ),
